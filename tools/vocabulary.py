...
THEMES = {
    ...
    'animals': """
        ...
        কাঠবিড়ালি মশা পিঁপড়া মাকড়সা কবুতর পায়রা টিয়া কোকিল শালিক চিল বক হাঁস
    """,
    'food': """
        ভাত রুটি ডিম দুধ আম কলা রুটি চিনি লবণ তেল পানি জল মাখন সবজি ফল আপেল কমলা পেয়ারা নারকেল
        মিষ্টি রস গম টক রসগোল্লা দুধভাত বিস্কুট স্বাদ যব ডাল ডালিম মূলা তৈল মাংস আটা মধু দই
        পেঁয়াজ রসুন আদা মরিচ তরকারি খাবার নাশতা আনারস পেঁপে তরমুজ আঙুর লিচু বেগুন আলু টমেটো
        গাজর শিম কচু লাউ কুমড়া মিছরি কফি শরবত পিঠা মটর পটল
    """,
    'body': """
    ...
    'school': """
        ...
        প্রশ্ন শব্দ বানান গণিত ইতিহাস ভূগোল বিজ্ঞান ক্লাস খবর হরফ ফলক জগত
    """,
    'getting about': """
    ...
    'doing': """
        ...
        নাচা গাওয়া লাফানো সাঁতার রাগ নকল চমক ঝলক হজম নজর
    """,
    'describing': """
