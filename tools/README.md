...
The 73 levels in the game are generated from `catalogue.py`, not typed into the app. This
...
generator are run over all 73 levels and their boards compared cell by cell. If you change a
